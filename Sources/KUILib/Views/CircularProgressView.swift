...
//  
//
//  Created by An Nguyen on 29/01/2024.
//
...
@objc @IBDesignable open class CircularProgressView: UIView {
    ...
    @objc func internalInit() {
        let displayLink = CADisplayLink(target: self, selector: #selector(CircularProgressView.displayLinkTick))
