...
extension UIView {
    ...
    public func fadeIn(duration: TimeInterval = 0.3, delay: TimeInterval = 0.0, completion: ((Bool) -> Void)? = nil) {
        // Initially set the view to transparent
        self.alpha = 0.0
    ...
    public func fadeOut(duration: TimeInterval = 0.3, delay: TimeInterval = 0.0, completion: ((Bool) -> Void)? = nil) {
